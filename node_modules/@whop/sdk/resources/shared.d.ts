...
import * as ResolutionCenterCasesAPI from "./resolution-center-cases.js";
 ...
 */
export type AuthorizedUserRoles = 'owner' | 'admin' | 'sales_manager' | 'moderator' | 'advertiser' | 'app_manager' | 'support' | 'manager' | 'custom';
/**
...
export declare namespace Company {
     ...
     * Null if none is configured.
     */
    interface FeaturedAffiliateProduct {
        /**
